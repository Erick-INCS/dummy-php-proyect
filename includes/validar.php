<?php
  ...
  $consulta = "SELECT idUsuario, expiration_date<=CURRENT_DATE() AS EXPIRED, user_role FROM usuarios where correo='$user' and claveUsuario=MD5('$pass')";
  ...
  if($filas>0)
  {
    ...
    $_SESSION['pass']=$pass;
    $_SESSION['admin']=$filas['user_role'] == 'admin';
